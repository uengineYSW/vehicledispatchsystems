<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text style="background-color: white;">
            ...
            <String label="소속" v-model="value.affiliation" :editMode="editMode" :inputUI="''"/>
            <String label="연락처" v-model="value.contactNumber" :editMode="editMode" :inputUI="''"/>
            <Boolean label="사용여부" v-model="value.isAvailable" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
