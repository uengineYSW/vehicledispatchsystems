    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    ...
                    <div class="secondary-text-color" style="margin-left:30px;">차량의 등록과 관련된 기능을 관리</div>
                </v-list-item>
            </v-row>
        </v-card>
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <VehicleManagementVehicle :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <VehicleManagementVehicle :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import VehicleManagementVehicle from './../VehicleManagementVehicle.vue';

    export default {
        name: 'VehicleManagementVehicleManager',
        components: {
            VehicleManagementVehicle,
        },
        props: {
            offline: Boolean
        },
