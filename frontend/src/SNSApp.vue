            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="vehicles"
                        to="/vehicleManagements/vehicles"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '사용자', 
                description: '차량 배차를 요청하는 사용자', 
                key: 'users', 
                route: '/userManagements/users',
                ImageUrl: '',
            },
            { 
                title: '운전자', 
                description: '차량 배차 요청에 응답하여 이동 서비스를 제공하는 운전자', 
                key: 'drivers', 
                route: '/driverManagements/drivers',
                ImageUrl: '',
            },
            { 
                title: '차량', 
                description: '차량의 등록과 관련된 기능을 관리', 
                key: 'vehicles', 
                route: '/vehicleManagements/vehicles',
                ImageUrl: '',
            },
