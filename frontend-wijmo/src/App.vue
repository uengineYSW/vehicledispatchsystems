...
export default {
    ...
    data: () => ({
        ...
        urlPath: null,
        menus: [
            { id: 'userManagement', title: '사용자 관리',
                items: [
                    { key: 'users', url: '/users', name: '사용자' },
                ]
            },
            { id: 'driverManagement', title: '운전자 관리',
                items: [
                    { key: 'drivers', url: '/drivers', name: '운전자' },
                ]
            },
            { id: 'vehicleManagement', title: '차량 관리',
                items: [
                    { key: 'vehicles', url: '/vehicles', name: '차량' },
                ]
            },
        ],
        cards: [
